...
Designing a scalable data warehouse using modern engineering standards.
...
Creating dimension and fact tables optimized for analytics.

### 🔹 4. Reporting & Insight Generation

Writing SQL queries to uncover business insights such as:

* Customer trends
* Product performance
* Sales patterns over time

This project helps me develop strong skills in:
...
* **Notion** – Planning and tracking project phases.

---

## 🎯 Project Goal (Data Engineering Focus)

The main goal was to build a functioning, well‑structured data warehouse capable of supporting analytical queries.

### Requirements I worked on:

* Importing data from two systems (ERP + CRM)
* Cleaning and standardizing messy data
* Joining and integrating the sources
* Building a clear star schema
* Documenting my model & architecture for analytics teams
* Generating SQL‑based insights

This is a foundational project for real-world data engineering work.
...
├── docs/              # Architecture diagrams, catalog, naming conventions
